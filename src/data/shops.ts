...
export const shops: Shop[] = [
  {
    ...
    tagline: 'Classic Cambridge barbering on Magdalene Street.',
    intro: 'Established in 1991, Il Barbiere offers traditional walk-in barbering from Magdalene Street, close to Bridge Street, Quayside and Cambridge city centre.',
    serviceIntro: 'Walk-ins only. Prices are shown from the current in-shop price list and can be checked in person before your cut.',
    ...
    seoDescription: 'Walk-in barbering at Il Barbiere, 22 Magdalene St, Cambridge CB3 0AF. Traditional cuts, clipper cuts, student haircuts and children’s cuts.',
    localSeoHeading: 'Traditional walk-in barber near Magdalene Street, Cambridge',
    localSeoBody: 'Il Barbiere is a long-established Cambridge barber for customers looking for a traditional walk-in cut near Magdalene Street, Bridge Street, Quayside and the historic city centre. The page is written to help local customers find the shop when searching for a barber in central Cambridge, while keeping the tone classic and understated.',
    localSeoPoints: ['Magdalene Street location', 'Established in 1991', 'Walk-ins only', 'Central Cambridge barber'],
    highlights: [
    ...
    services: [
      ...
      { name: 'Children under 13', price: '£15', note: 'Children’s haircut for under 13s.' },
  ...
  },
  {
    ...
    tagline: 'Your local Histon barber — book online or walk in.',
    intro: 'A friendly high-street barber for Histon, Impington and north Cambridge, offering haircuts, skin fades, beard trims, shaves and kids cuts.',
    serviceIntro: 'Book online through Booksy or walk in when available. Prices are taken from the current in-shop price list.',
    ...
    seoDescription: 'Book a haircut, skin fade, beard trim, wet shave or kids cut at Histon Barber Shop, 2 High Street, Histon, Cambridge CB24 9LG.',
    localSeoHeading: 'Local barber on Histon High Street',
    localSeoBody: 'Histon Barber Shop is the local high-street option for customers in Histon, Impington and north Cambridge who want a straightforward haircut, skin fade, beard trim, wet shave or kids cut. The wording is designed to help Google understand the shop’s location and services while keeping the site simple for real customers.',
    ...
    highlights: [
      ...
      { title: 'Full barber menu', text: 'Cuts, fades, beard trims, wet shaves and kids cuts.' },
    ],
    services: [
      ...
      { name: 'Children under 12', price: '£15', note: 'Children’s haircut for under 12s.' },
      ...
      { name: 'Dads with Lads', price: '£2 off', note: 'Offer shown on the in-shop price list.' },
    ],
  ...
  },
  {
    ...
    intro: 'A contemporary Cambridge city-centre barber on St Andrew’s Street, offering skin fades, restyles, dry cuts, wash and cuts, beard shaping and towel shaves.',
    serviceIntro: 'Book online through Booksy or walk in when available. Prices are taken from the current Parker’s in-shop price list.',
    ...
    seoDescription: "Book online or walk in at Parker’s Barber Shop, 39a St Andrew's St, Cambridge CB2 3AR. Skin fades, restyles, dry cuts, beard shaping and towel shaves.",
    localSeoHeading: 'City-centre barber on St Andrew’s Street, Cambridge',
    localSeoBody: 'Parker’s Barber Shop is positioned for Cambridge city-centre customers looking for a clean haircut, sharp skin fade, restyle, beard shape or towel shave close to St Andrew’s Street, the Grand Arcade and central shopping streets. The copy gives the site stronger local search substance while staying clear and practical for customers.',
    localSeoPoints: ['St Andrew’s Street location', 'Cambridge city-centre barber', 'Skin fades, restyles and towel shaves', 'Book online or walk in'],
    highlights: [
      { title: 'Book or walk in', text: 'Use Booksy for appointments, or walk in when the shop has space.' },
      { title: 'City-centre location', text: 'Find Parker’s on St Andrew’s Street in central Cambridge.' },
      { title: 'Sharp modern services', text: 'Skin fades, restyles, beard shaping and towel shaves.' },
    ],
    services: [
      ...
      { name: 'Children under 15', price: '£15', note: 'Children’s haircut for under 15s.' },
