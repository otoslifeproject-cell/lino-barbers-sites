...
export const shops: Shop[] = [
  {
    ...
    intro: 'Established in 1991, Il Barbiere offers traditional walk-in barbering from Magdalene Street, close to Bridge Street, Quayside, Cambridge city centre and the punts on the River Cam.',
