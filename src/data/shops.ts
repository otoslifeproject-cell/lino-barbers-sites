...
export const shops: Shop[] = [
  {
    ...
    seoDescription: 'Walk-in barbering at Il Barbiere, 22 Magdalene St, Cambridge CB3 0AF. Traditional cuts, clipper cuts, student haircuts and younger customer cuts.',
    localSeoHeading: 'Traditional walk-in barber near Magdalene Street, Cambridge',
    localSeoBody: 'Il Barbiere is a long-established Cambridge barber for customers looking for a traditional walk-in cut near Magdalene Street, Bridge Street, Quayside and the historic city centre. Drop in for straightforward barbering in a classic central Cambridge setting.',
  ...
  },
  {
    ...
    serviceIntro: 'Choose from sharp skin fades, restyles, dry cuts, wash and cuts, beard shaping, towel shaves and clipper cuts. Book online or walk in when available.',
    ...
    localSeoBody: 'Parker’s Barber Shop is for Cambridge city-centre customers looking for a clean haircut, sharp skin fade, restyle, beard shape or towel shave close to St Andrew’s Street, the Grand Arcade and central shopping streets. Book online or walk in when available.',
